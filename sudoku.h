...
/* FUNCTION THAT READS IN CHARACTERS FROM FILENAME INTO A TWO-DIMENSIONAL CHARACTER ARRAY BOARD */
void load_board(const char* filename, char board[9][9]);

/* FUNCTION THAT DISPLAYS THE TWO-DIMENSIONAL CHARACTER ARRAY BOARD IN A SUDOKU LAYOUT*/
